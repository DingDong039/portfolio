  ...
  return (
    <section id="about" className="relative px-5 sm:px-7 py-16 sm:py-24 scroll-mt-14">
      <div className="mx-auto max-w-6xl relative z-[var(--z-content)]">
        <SectionHeader index="§3" label="about">
        ...
        <div className="marginalia">
          <Reveal as="div" className="margin-label">
            Fig. 03
            <span className="block text-[var(--fg-4)]">narrative</span>
          </Reveal>

          <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-8 lg:gap-12 min-w-0">
            {/* narrative */}
            <Reveal as="div">
                    ...
                    <dl className="flex flex-col gap-2">
                      {r.rows.map(([k, v]) => (
                        <div key={k} className="flex justify-between items-baseline gap-3">
                          ...
                          <dd className="font-mono text-[0.78rem] text-[var(--fg)] text-right shrink-0">{v}</dd>
                        </div>
                      ))}
                    </dl>
                  </div>
