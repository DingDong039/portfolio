...
export const metadata: Metadata = {
  ...
  description:
    "Professional portfolio of Watchara Tongyodpun (วัชระ ทองยอดพันธ์) - Full Stack Developer specializing in React, Next.js, TypeScript, and modern web development. View my projects, skills, and get in touch.",
  keywords: [
    "Watchara Tongyodpun",
    "วัชระ ทองยอดพันธ์",
  ...
  openGraph: {
    ...
    description:
      "Professional portfolio showcasing web development projects, technical skills, and contact information of Watchara Tongyodpun.",
  ...
  twitter: {
    ...
    title: "Watchara Tongyodpun - Full Stack Developer | Portfolio",
    description:
      "Professional portfolio showcasing web development projects, technical skills, and contact information.",
    creator: "@watchara",
    images: ["/og-image.jpg"],
  },
  robots: {
